...
?>
    ...
    ?>      <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <br><br>
            <label for = "Verification">Provide Your Valid ID for Verification Purposes.(Aadhar, PAN, Passport) </label><br><br>
            <input type="file" class="form-control" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx,.docx" name="Verification" id = "id" placeholder="ID Verification">
            <br>
            ...
            <div class="checkbox">
            <label for = "checkbox-1"> Checked All details?</label>
            <div class="checkbox__1">
                <input id="checkbox-1" type="checkbox" required>
                <label for="checkbox-1">
                <i class="material-icons">done</i></label>
            ...
            <div class="checkbox">
            <label for = "checkbox-1"> You agree to Share your Images with Our Platform?</label>
            <div class="checkbox__1">
                <input id="checkbox-1" type="checkbox" required>
                <label for="checkbox-1">
                <i class="material-icons">done</i></label>
